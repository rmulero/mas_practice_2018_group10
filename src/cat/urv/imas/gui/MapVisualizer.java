...
//    }
    ...
    @Override
    public void drawCleaner(PathCell cell) {
        drawEmptyPath(cell);
        drawAgent(Color.RED, cell.getMapMessage(), Color.BLACK);
    }
    
    @Override
    public void drawSearcher(PathCell cell) {
        drawEmptyPath(cell);
        drawAgent(Color.ORANGE, cell.getMapMessage(), Color.BLACK);
    }
    
    @Override
    public void drawRecyclingPoint(RecyclerPointCell cell) {
        // drawCell(Color.RED, Color.GREEN);
        drawCell(Color.BLUE, Color.YELLOW);
        /*try {
    ...
    @Override
    public void drawBatteriesChargePoint(BatteriesChargeCell cell) {
        drawCell(Color.GREEN, Color.GREEN);
        //drawString(cell.getMapMessage(), Color.GREEN, dx - 80, dy);
    }
    ...
    public void drawField(FieldCell cell) {
        ...
        drawCell(Color.CYAN.darker(), Color.BLACK);
        //drawCell(Color.BLACK.brighter(), Color.LIGHT_GRAY);
