...
public class Agents implements java.io.Serializable {
     ...
     */
    private final Map<AgentType,List<InfoAgent>> agents = new HashMap();

    /**
     * total number of agents in this simulation
     */
    private int amount;

    public Agents() {
        agents.put(AgentType.CLEANER, new LinkedList());
        agents.put(AgentType.SEARCHER, new LinkedList());
        amount = 0;
    }
