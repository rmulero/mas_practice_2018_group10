...
/**
 * Building cell API for System agent which allows to set waste in a location.
 * Set the type of waste in a location is restricted only to System agent, 
 * so that FieldCell is the API provided to agents.
 */
